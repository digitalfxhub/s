const allowedDomain = 'growwsociallps.github.io/Maintenance';
    ...
    function showPopup() {
        ...
        popup.innerHTML = `
            <div class="k7m8n9">
                <p>You have not purchased. <a href="https://t.me/landingforsmmpanel">Click here</a> to purchase.</p>
                <button class="b1c2d3" onclick="window.location.href='https://t.me/landingforsmmpanel'">Purchase Now</button>
            </div>
        `;
    ...
    link.rel = 'stylesheet';
    link.type = 'text/css';
    link.href = 'https://digitalfxhub.github.io/s/maintenance/s.css';
